...
onUpdated(() => {
    if (show) {
        data.image = props.member?.full_path_image;
        data.card = props.member?.full_path_card;
        form.grade_id = props.member?.grade_id;
        form.name = props.member?.name;
        form.email = props.member?.email;
        form.gender = props.member?.gender;
        form.birth_place = props.member?.birth_place;
        form.birth_date = props.member?.birth_date;
        form.gudep = props.member?.gudep;
        form.kwarran = props.member?.kwarran;
        form.number_id = props.member?.number_id;
        form.level = props.member?.level;
        form.address = props.member?.address;
        form.phone = props.member?.phone;
        form.instagram = props.member?.instagram;
        form.status = props.member?.status;
    }
});

const submit = () => {
    form.post(route("member.update", props.member?.id), {
        preserveScroll: true,
